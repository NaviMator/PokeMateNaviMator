...
require (baseFolder.."src/script_functions_mechanics")  -- List of hardcoded mechanics to make decisions in fights
...
require (baseFolder.."src/script_routes")               -- Scripts of available routes
